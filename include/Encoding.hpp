...
namespace encoding {
     ...
     */
    void     mono_trans(const char *seq, int len, float *params) noexcept;
    /**
     ...
     * @param params    The output Z-curve parameters.
     */
    void     di_trans  (const char *seq, int len, float *params) noexcept;
    /**
     ...
     * @param params    The output Z-curve parameters.
     */
    void     tri_trans (const char *seq, int len, float *params) noexcept;
    /**
     * @deprecated
     ...
     * @param params    The output Z-curve parameters.
     */
    void     quart_trans(const char *seq, int len, float *params) noexcept;
    /**
     ...
     */
    void     encode     (const char *seq, int len, float *data, int n_trans) noexcept;
    /**
     ...
     */
    float * std_scale(float *data, int n, int dim, const float *means, const float *stds) noexcept;
    /**
     ...
     * @return          The transformed Z-curve params.
     */
    float * minmax_scale(float *data, int n, int dim, float *mins, float *maxs) noexcept;
}
